...
$sub_folder = '';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'SUPPORT EMAIL GOES HERE'); # Email of site support
define('PREFIX', 'DATABASE TABLE PREFIX GOES HERE'); #Adds uniqueness to DB table names.  Limits hackability, naming collisions.  In WordPress the prefix is wp_
